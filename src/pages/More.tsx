...
export default function More() {
    ...
    return (
        <div className="min-h-screen bg-black text-gray-300 font-sans relative">
            {/* Sciame di particelle interattivo - Fixed */}

            <ParticleSwarm />


            {/* Animated Aurora Background - Fixed */}
            <div className="fixed inset-0 z-0 bg-gradient-to-br from-black via-purple-950 to-black">
            ...
            {/* Overlay per migliorare la leggibilità - Fixed */}
